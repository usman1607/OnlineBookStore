...
@Service
@Qualifier("ussdCheckoutService")
public class USSDCheckoutService implements ICheckoutService {
    private final CartRepository cartRepository;
    private final CreateCheckout createCheckout;

    public USSDCheckoutService(CartRepository cartRepository, CreateCheckout createCheckout) {
    ...
    public CheckoutDto processCheckout(Long cartId) {
        ...
        //Process USSD Payment integration here... after successful payment.

        return createCheckout.create(cart, PaymentMethod.USSD);
    }
}
